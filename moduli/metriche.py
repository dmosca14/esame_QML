...
def kernel_target_alignment(K, y):
    ...
    # Conversione a {-1, +1} dei target per il calcolo del KTA.
...
def coefficiente_geometrico(K_classico, K_quantistico, lambda_reg=1e-6):
    ...
    # Il coefficiente è la radice quadrata della norma spettrale di M (la norma spettrale per matrici simmetriche è il massimo autovalore assoluto).
