...
def costruisci_qsvm(train_set_raw, test_set_raw, numero_features, modulo_encoding, iperparametri_quantistici, iperparametri_classici, nome_dataset=""):
    ...
    set_adattato, matrici_gram, modello, storico, migliori_ip_quantistici, migliori_ip_classici = addestramento(
    ...
    return modello, set_adattato, matrici_gram, storico, migliori_ip_quantistici, migliori_ip_classici
